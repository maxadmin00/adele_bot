...
class Agent:
    def __init__(self, num_players):
        ...
        system_prompt = (f"""
            ...
            Чтобы разыграть фишку опасности выбери комнату в которую ее хочешь поместить и имеющуюся фишку
            Чтобы сыграть карту опасностей "пожар" в комнату 3:
            <tool_call>
            {"name": "play_hazard_card", "arguments": {"room": 3, "cap": "пожар"}}
            </tool_call>

            Чтобы сыграть карту аномалий выбери порядковый номер карты аномалий из имеющихся
            Чтобы разыграть карту аномалий под индексом 1:
            <tool_call>
            {"name": "play_anomaly_card", "arguments": {"anomaly_ind": 0}}
            </tool_call>
            ...
            Обращай внимание на ошибки от инструментов, внимательно следи за своими картами и не пробуй повторять одну и ту же ошибку
